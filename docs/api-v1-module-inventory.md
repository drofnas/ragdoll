...
| `documents` | `/api/v1/documents` | scaffolded | Space-scoping contract will adopt shared `SpaceScope` during migration. |
...
| `usage` | `/api/v1/usage` | scaffolded | Will join with users/account concerns later. |
