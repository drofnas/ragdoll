...
from ragdoll.core.exceptions import ApplicationError, ConfigurationError
...
def retrieve_search_results(
    ...
    *,
    ...
    results = [candidate.result for candidate in ranked]
...
def search_documents(
    ...
    *,
    ...
    total = len(results)
    page_items = results[pagination.offset : pagination.offset + pagination.page_size]
