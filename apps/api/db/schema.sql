...
--
-- Name: pinned_fact_candidates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: pinned_facts; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.pinned_facts (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    value_kind character varying(16),
    value_text text,
    value_json json,
...
--
-- Name: pinned_fact_candidates pinned_fact_candidates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history pinned_fact_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_facts pinned_facts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pinned_facts
    ADD CONSTRAINT pinned_facts_pkey PRIMARY KEY (id);
...
--
-- Name: pinned_fact_candidates ux_pinned_fact_candidates_fact_idempotency; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_facts ux_pinned_facts_space_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pinned_facts
    ADD CONSTRAINT ux_pinned_facts_space_key UNIQUE (space_id, key);
...
--
-- Name: ix_change_events_pinned_fact_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_change_events_pinned_fact_id ON public.change_events USING btree (pinned_fact_id);
...
--
-- Name: ix_correction_records_pinned_fact_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_correction_records_pinned_fact_id ON public.correction_records USING btree (pinned_fact_id);
...
--
-- Name: ix_document_chunk_vectors_document_chunk_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_document_chunk_vectors_document_chunk_index ON public.document_chunk_vectors USING btree (document_id, chunk_index);
...
--
-- Name: ix_document_chunk_vectors_embedding_hnsw_cosine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_document_chunk_vectors_embedding_hnsw_cosine ON public.document_chunk_vectors USING hnsw (embedding public.vector_cosine_ops);
...
--
-- Name: ix_entities_canonical_entity_id_created_at_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_entities_canonical_entity_id_created_at_id ON public.entities USING btree (canonical_entity_id, created_at DESC, id DESC);
...
--
-- Name: ix_entities_chunk_id_entity_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_entities_chunk_id_entity_type ON public.entities USING btree (chunk_id, entity_type);
...
--
-- Name: ix_entities_document_id_canonical_entity_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_entities_document_id_canonical_entity_id ON public.entities USING btree (document_id, canonical_entity_id);
...
--
-- Name: ix_graph_edges_document_id_weight_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_graph_edges_document_id_weight_id ON public.graph_edges USING btree (document_id, weight DESC, id);
...
--
-- Name: ix_pinned_fact_candidates_pinned_fact_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_fact_candidates_source_document_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_fact_candidates_space_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_fact_candidates_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_fact_history_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_fact_history_pinned_fact_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_fact_history_space_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_pinned_facts_is_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_pinned_facts_is_active ON public.pinned_facts USING btree (is_active);


--
-- Name: ix_pinned_facts_owner_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_pinned_facts_owner_user_id ON public.pinned_facts USING btree (owner_user_id);


--
-- Name: ix_pinned_facts_space_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_pinned_facts_space_id ON public.pinned_facts USING btree (space_id);


--
-- Name: ix_pinned_facts_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: change_events change_events_pinned_fact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.change_events
    ADD CONSTRAINT change_events_pinned_fact_id_fkey FOREIGN KEY (pinned_fact_id) REFERENCES public.pinned_facts(id) ON DELETE SET NULL;
...
--
-- Name: correction_records correction_records_pinned_fact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.correction_records
    ADD CONSTRAINT correction_records_pinned_fact_id_fkey FOREIGN KEY (pinned_fact_id) REFERENCES public.pinned_facts(id) ON DELETE SET NULL;
...
--
-- Name: pinned_fact_candidates pinned_fact_candidates_pinned_fact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_candidates pinned_fact_candidates_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_candidates pinned_fact_candidates_source_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_candidates pinned_fact_candidates_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history pinned_fact_history_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history pinned_fact_history_candidate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history pinned_fact_history_pinned_fact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history pinned_fact_history_restored_from_history_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_fact_history pinned_fact_history_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pinned_facts pinned_facts_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pinned_facts
    ADD CONSTRAINT pinned_facts_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: pinned_facts pinned_facts_source_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pinned_facts
    ADD CONSTRAINT pinned_facts_source_document_id_fkey FOREIGN KEY (source_document_id) REFERENCES public.documents(id) ON DELETE SET NULL;


--
-- Name: pinned_facts pinned_facts_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pinned_facts
    ADD CONSTRAINT pinned_facts_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id) ON DELETE CASCADE;
